...
namespace SmartFactory.Application.Migrations
{
    ...
    [Migration("20260113074752_AddImageUrlToPartEntity")]
    partial class AddImageUrlToPartEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartFactory.Application.Entities.PMCCell", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PMCRowId", "WorkDate")
                        .IsUnique();

                    b.ToTable("PMCCells");
                });

            modelBuilder.Entity("SmartFactory.Application.Entities.PMCRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PMCWeekId");

                    b.HasIndex("PMCWeekId", "ProductCode", "ComponentName", "PlanType");

                    b.ToTable("PMCRows");
                });

            modelBuilder.Entity("SmartFactory.Application.Entities.PMCWeek", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WeekStartDate", "Version")
                        .IsUnique();
            ...
            modelBuilder.Entity("SmartFactory.Application.Entities.PMCCell", b =>
                {
                    b.HasOne("SmartFactory.Application.Entities.PMCRow", "PMCRow")
                        .WithMany("Cells")
                        .HasForeignKey("PMCRowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartFactory.Application.Entities.PMCRow", b =>
                {
                    ...
                    b.HasOne("SmartFactory.Application.Entities.PMCWeek", "PMCWeek")
                        .WithMany("Rows")
                        .HasForeignKey("PMCWeekId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Customer");

                    b.Navigation("PMCWeek");
                });

            modelBuilder.Entity("SmartFactory.Application.Entities.PMCWeek", b =>
                {
                    b.HasOne("SmartFactory.Application.Entities.User", "Creator")
                        .WithMany()
